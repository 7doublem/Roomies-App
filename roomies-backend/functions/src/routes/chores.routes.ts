...
choreRoutes.post(
  ...
  authenticateUser,
  ChoreController.createChoreByGroupId
);
...
choreRoutes.get(
  "/groups/:group_id/chores",
  authenticateUser,
  ChoreController.getAllChoresByGroupId
);
...
choreRoutes.patch(
  ...
  authenticateUser,
  ChoreController.patchChoreByChoreId
);

// DELETE /groups/:group_id/chores/:chore_id - delete a chore by chore_id
choreRoutes.delete(
  "/groups/:group_id/chores/:chore_id",
  authenticateUser,
  ChoreController.deleteChoreByChoreId
);
