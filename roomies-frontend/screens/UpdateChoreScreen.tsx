  ...
  return (
    <GradientContainer>
      <Animated.View style={fadeStyle}>
        <Text style={[styles.title, { marginBottom: 16, alignSelf: 'center' }]}>Update a Chore</Text>
        {error && (
        ...
        <Animated.View style={animatedDescStyle}>
          <TextInput
            ...
            style={[styles.input, { height: 100, textAlignVertical: 'top', borderWidth: 0, marginBottom: 0 }]}
            multiline
            placeholderTextColor="#222"
        ...
        <TextInput
          ...
          style={[styles.input, { marginBottom: 16, borderRadius: 8, backgroundColor: '#fff', borderWidth: 2, borderColor: '#ccc' }]}
          placeholderTextColor="#222"
        />
        <TextInput
